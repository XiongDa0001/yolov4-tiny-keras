...
from keras.layers import (Concatenate, Conv2D, MaxPooling2D, ZeroPadding2D,SeparableConv2D,add)
...
def DarknetConv2D(*args, **kwargs):
    ...
    darknet_conv_kwargs['padding'] = 'valid' if kwargs.get('strides')==(2,2) else 'same'#步长为2的时候的same填充
...
def darknet_body(x):
    ...
    # x = addconv(x, num_filters=128)
    # x = addconv(x, num_filters=256)
