...
from nets.attention import cbam_block, eca_block, se_block, ms_cam
from utils.utils import compose

attention_block = [se_block, cbam_block, eca_block, ms_cam]
...
def yolo_body(inputs, num_anchors, num_classes, phi=0):
    if phi >= 5:
        raise AssertionError("Phi must be less than or equal to 4 ( 1, 2, 3, 4).")
    #---------------------------------------------------#
    ...
    # P5 = Inception_resnetV1(P5 , num_filters=258)
    # 13,13,256 -> 13,13,512 -> 13,13,255x
    ...
    # feat1 = Inception_resnetV1(feat1 , num_filters=128)
    ...
    P4_downsample = DarknetConv2D_BN_Leaky(512, (3, 3), strides=(2, 2))(P4_downsample)
    if 1 <= phi and phi <= 4:
        P4_downsample = attention_block[phi-1](P4_downsample, name="P4_downsample")

    P5 = Concatenate()([P4_downsample, P5]) #通道变成768
    '''
